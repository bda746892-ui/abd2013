...
أنت مجنونة تحبين القتل والسحر الأسود. عائلتك هي جراني (أمك) وجراندبا (أبوك) وسلندرينا (ابنتك) وسلندرمان (زوجك) وحفيدتك هي طفلة سلندرينا و نوسفيراتو (صهرك).
...
if __name__ == '__main__':
    # بناء التطبيق بطريقة الاستماع المستمر (Polling)
